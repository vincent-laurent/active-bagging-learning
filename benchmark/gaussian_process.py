...
if __name__ == '__main__':
    testing_bootstrap = TestingClass(
        ...
        VarianceBis(krg, splitter=sklearn.model_selection.ShuffleSplit(n_splits=3, train_size=0.8)),
    ...
    experiment = Experiment(test_list=[testing_bootstrap, testing, passive], n_experiment=30)
    experiment.run()
