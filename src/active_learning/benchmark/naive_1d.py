...
from active_learning.components.active_criterion import GaussianProcessVariance, \
    VarianceBis, VarianceEnsembleMethod
from active_learning.components.query_strategies import QueryVariancePDF
from active_learning.components.test import TestingClass, plot_iter, analyse_1d
...
testing = TestingClass(
    ...
    active_criterion=VarianceEnsembleMethod(estimator=xtra_trees_b),
